Release v2.0, 2026-05-07

- The data structure was adapted to match FAO's new reporting structure of Food and Commodity Balances.
- Accordingly, also the time series was updated to cover 2010-2023.
- Country coverage was reduced to 180 + RoW, removing countries not existent during the covered time period or without data being reported.
- The livestock module was improved by integrating FAO's GLEAM model.
